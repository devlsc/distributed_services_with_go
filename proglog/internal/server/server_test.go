...
import (
	...
	"github.com/devlsc/distributed_services_with_go/proglog/internal/config"
	"github.com/devlsc/distributed_services_with_go/proglog/internal/log"
...
func testUnauthorized(
	...
	if produce != nil {
		t.Fatalf("produce responds should be nil")
	}
	...
	if consume != nil {
		t.Fatalf("consume responds should be nil")
	}
